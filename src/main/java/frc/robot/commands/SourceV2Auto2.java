...
/**
 * This is a hastily made duplicate of SourceV2Auto from Hopper elims, but with a different starting path
 * that takes us to centerline 4 instead of 5.
 */
public class SourceV2Auto2 extends SequentialCommandGroup {

  public SourceV2Auto2(DrivetrainSubsystem drivetrain,
    ...
    addCommands(
      Commands.deadline(
        Commands.sequence(
          ...
          Commands.parallel(
            (shootOnTheFlyFar ? 
              intakeMoveShoot("Bottom_2_OnTheFly2", false, 0.3, null, 0, noteBypass ? false : null) 
            :
              intakeMoveAim("Bottom_2_OnTheFly2", false, 0.5, null, noteBypass ? false : null)
            ),
