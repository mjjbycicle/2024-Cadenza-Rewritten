...
public class RobotContainer {
  ...
  public final SendableChooser<DriverStation.Alliance> allianceChooser =
      new SendableChooser<DriverStation.Alliance>();
  ...
  public RobotContainer() {
    ...
    shootAllAligned =
        new Trigger(
            () -> {
              return drivetrain.isAlignedToSpeaker()
                  && shooter.isAtTargetSpeed()
                  && shooterPivot.isAligned();
            });

    shootMechanismsAligned =
        new Trigger(
            () -> {
    ...
    autoChooser.addOption(
        "Amp RACE: 2W -> 5, 4, 3, 2",
        new AmpRaceAuto(
            drivetrain, vision, shooter, shooterPivot, intake, false, 5, 4, 3, 2));
    autoChooser.addOption(
        "Amp RACE: 2W -> 4, 5, 3, 2",
        new AmpRaceAuto(
            drivetrain, vision, shooter, shooterPivot, intake, false, 4, 5, 3, 2));
    autoChooser.addOption(
        "Amp RACE: 2W -> 4, 3, 2",
        new AmpRaceAuto(
            drivetrain, vision, shooter, shooterPivot, intake, false, 4, 3, 2));
    autoChooser.addOption(
        "Amp RACE: 2W -> 5, 4 -> 2W",
        new AmpRaceAuto(
            drivetrain, vision, shooter, shooterPivot, intake, true, 5, 4));
    autoChooser.addOption(
        "Amp RACE: 2W -> 4, 5 -> 2W",
        new AmpRaceAuto(
            drivetrain, vision, shooter, shooterPivot, intake, true, 4, 5));

    autoChooser.addOption(
        "Middle FAST: 4W -> 5, 4, 3, 2",
        new FourNoteOTFAuto(
            drivetrain, vision, shooter, shooterPivot, intake, 5, 4, 3, 2));
    autoChooser.addOption(
        "Middle FAST: 4W -> 4, 3, 2",
        new FourNoteOTFAuto(
            drivetrain, vision, shooter, shooterPivot, intake, 4, 3, 2));
    autoChooser.addOption(
        "Middle FAST: 3W -> 3",
        new Middle3Auto(drivetrain, vision, shooter, shooterPivot, intake, true));
    autoChooser.addOption(
        "Middle FAST: 3W",
        new Middle3Auto(drivetrain, vision, shooter, shooterPivot, intake, false));

    autoChooser.addOption(
        "Source FAST: 1W -> 1, 2, 3",
        new SourceV2Auto(
            drivetrain, vision, shooter, shooterPivot, intake, true, 2, 3));
    autoChooser.addOption(
        "Source FAST: 1W -> 2, 3",
        new SourceV2Auto2(drivetrain, vision, shooter, shooterPivot, intake, true, 3));
    autoChooser.addOption(
        "Source FAST Integrity: 1W -> 1, 2, 3",
        new SourceV2Auto(
            drivetrain, vision, shooter, shooterPivot, intake, false, 2, 3));
  ...
  private void configureBindings() {
    ...
    final Trigger scoreHeldTimeout =
        new Trigger(
            () -> {
    ...
    drivetrain.setDefaultCommand(
        new DefaultDriveCommand(drivetrain, yAxisSupplier, xAxisSupplier, rotationSupplier));
    ...
    if (shooter != null) {
      ...
      shooter.setDefaultCommand(
          shooter.run(
              () -> {
                ...
                if (intake.isNoteDetected() && speakerDistance <= 9) {
      ...
      driverController
          ...
          .whileTrue(
              Commands.parallel(
                  ...
                  new RunShooter(
                      shooter,
                          RobotInfo.ShooterInfo.SHOOTER_AUTON_IDLE_SPEED), // Override in case the auto-rev is not working
      ...
      if (amp != null) {
        Command ampLoadWithSensor =
            Commands.sequence(
                new IntakePivotCommand(intakePivotSubsystem.AMP_FEED)
                    .withRunOnce(true),
                new AmpPose(amp, AmpSubsystem.STOW)
                    .until(() -> amp.isAligned() && intakePivot.isAligned()),
                Commands.deadline(
                    Commands.waitUntil(() -> amp.isNoteDetected())
                        .andThen(Commands.waitSeconds(0.2)),
                    Commands.parallel(
                        intake.setIntakeSpeedCommand(-0.3), amp.setRollerSpeed(-0.30))));
        ...
        new Trigger(amp::awayFromScorePose)
      ...
      driverController
          ...
          .whileTrue(
              Commands.parallel(
                  ...
                  new IntakePivotCommand(intakePivotSubsystem.FEED_SHOT),
                  drivetrain.targetHeadingContinuous(
                      () -> {
      ...
      driverController
          ...
          .onFalse(
              Commands.parallel(
                  ...
                  Commands.either(
                      Commands.none(),
                      Commands.sequence(winch.runWinchToZero(-0.2, false), winch.servoLatch()),
                      winch::isClimbing)));
      ...
      driverController
          ...
          .whileTrue(
              Commands.parallel(
                  ...
                  new IntakePivotCommand(intakePivotSubsystem.TRAP_FEED),
      ...
      driverController
          ...
          .whileTrue(
              Commands.parallel(
                  Commands.sequence(
                      winch.runWinchToZero(-0.6, true), new RumbleCommand(0.5).withTimeout(0.5)),
    ...
    if (intake != null) {
      ...
      driverController
          ...
          .whileTrue(
              Commands.parallel(
                  new IntakePivotCommand(intakePivotSubsystem.FRONT),
                  new IntakeCommand(intake, true, 1),
                  new RunShooter(shooter, Constants.SHOOTER_IDLE_LOW)))
          .onFalse(
              Commands.either(
                  new IntakePivotCommand(intakePivotSubsystem.SHOOTER_FEED),
                  Commands.none(),
      ...
      driverController
          ...
          .whileTrue(
              Commands.sequence(
                      new IntakePivotCommand(intakePivotSubsystem.BACK)
                          .until(intakePivot::isAligned),
      ...
      driverController
          ...
          .onFalse(new IntakePivotCommand(intakePivotSubsystem.SHOOTER_FEED));
  ...
  public void periodic() {
    boolean aligned =
        drivetrain.isAlignedToSpeaker()
            && shooter.isAtTargetSpeed()
            && shooterPivot.isAligned()
            && intakePivot.isAligned();
  ...
  public Command setPDHChannel(boolean enabled) {
    return Commands.runOnce(() -> powerDistribution.setSwitchableChannel(enabled))
