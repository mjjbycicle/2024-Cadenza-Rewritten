...
public class Drive extends SubsystemBase {
  ...
  public void setLocked(Translation2d targetLock) {
    MovementUtil.setLocked(targetLock);
  }

  public void setLocked(Rotation2d rotation) {
    MovementUtil.setLocked(rotation);
  }

  public void lockedOff() {
    MovementUtil.setLocked(false);
  }

  public void setToDesired(Translation2d desiredPose) {
    MovementUtil.setToDesired(desiredPose);
  }

  public void toDesiredOff() {
    MovementUtil.setToDesired(false);
  }
