...
public class ControllerUtil {
  ...
  public static boolean getSpeakerShot() {
    return oi.operatorController()
        .getButton(Controls.OperatorControls.RunSpeakerShooterButton)
        .getAsBoolean();
  }

  public static boolean getAmpShot() {
    return oi.operatorController()
        .getButton(Controls.OperatorControls.RunAmpShooterButton)
        .getAsBoolean();
  }
  ...
  public static boolean idle() {
    return !getSpeakerShot() && !getLaunchFeed() && !getLaunchSpinup() && !getAmpShot();
  }
}
