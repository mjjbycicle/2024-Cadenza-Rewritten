...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs()
          .withKP(0.2)
          .withKI(0)
          .withKD(0) // These are simulator numbers, CTRE default was 3, 0, 0
          .withKS(0)
          .withKV(0)
          .withKA(0);
  ...
  // This needs to be tuned to your individual robot
  // public static final double kSpeedAt12VoltsMps = 5.0292; // TunerX had 5
  public static final double kSpeedAt12VoltsMps = DrivetrainSubsystem.MAX_SPEED;
  ...
  public static final String kCANbusName = "Pseudo-Tesla";
  ...
  private static final double kFrontLeftEncoderOffset = 0.265625;
  ...
  // private static final double kFrontRightEncoderOffset = -0.257080078125;
  ...
  // private static final double kBackLeftEncoderOffset = 0.36865234375;
  private static final double kBackLeftEncoderOffset = 0.36865234375 - 0.005;
  ...
  // private static final double kBackRightEncoderOffset = -0.27783203125; // SoFlo, 2nd retune
  // private static final double kBackRightEncoderOffset = -0.275390625; // 1st retune, "better" ?
  private static final double kBackRightEncoderOffset =
      -0.27; // Declared by nathan to be good at soflo sat
